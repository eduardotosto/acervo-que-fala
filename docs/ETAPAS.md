...
**Conclusão metodológica (resultado defensável para a banca):** o Qwen3-VL-8B atingiu o teto de obediência a prompt — com 25 regras concorrendo, cada regra nova passou a custar uma antiga. **Decisão: parar de extrair regras**, aplicar só 2 correções pontuais (fonte obrigatória para nomear ave; atribuição por fato, não por texto) e seguir para E8–E10, onde o painel humano julga pelos critérios oficiais. Defeitos residuais são o que as flags + interface de revisão (E11) existem para capturar.
