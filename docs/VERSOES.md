...
| 05 · v4 | reusa as do lote v10 (v3.1) | v13 (lida do resultado v10) | v1.4 | `05_bakeoff_gemma_v3.json` — a rodar | 28/08 | bake-off v2 com diagnóstico: resposta bruta + erro salvos, teste de fumaça |
